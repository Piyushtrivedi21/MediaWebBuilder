          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { 
                ...
                description: 'We review your resume and cover letter to assess your qualifications and experience.',
                icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'
              },
              { 
                title: 'Initial Interview', 
                description: 'A conversation with our HR team to learn more about you and your career aspirations.',
                icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z'
              },
              { 
                title: 'Skills Assessment', 
                description: 'A practical exercise or portfolio review to evaluate your technical abilities.',
                icon: 'M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z'
              },
              { 
                title: "Final Interview", 
                description: "Meet with the team you would be working with to ensure a good cultural fit.",
              ...
              <motion.div 
                ...
                viewport={{ once: true, amount: 0.3 }}
                variants={fadeIn(index * 0.1)}
                className="bg-[#121212] p-6 rounded-lg text-center border border-[#2A2A2A] relative"
              >
                <div className="w-12 h-12 rounded-full bg-[#2DD4BF] text-[#121212] flex items-center justify-center font-montserrat font-bold text-xl mx-auto mb-6">
                  <span>{index + 1}</span>
                </div>
