...
export const services: Service[] = [
  {
    ...
    description: "Improve your website's visibility in search engine results with our comprehensive SEO strategies.",
  ...
  },
  {
    ...
    description: "Drive targeted traffic and generate leads with strategic pay-per-click campaigns.",
